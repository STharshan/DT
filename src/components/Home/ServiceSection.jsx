...
Once you have had a DT DETAIL you will automatically be enrolled on to the maintenance scheme`,
  ...
  },
  {
    ...
    desc: `
The DT MACHINE POLISH is a full Stage 1 polish of the paintwork including wing mirrors`,
    image: "/paint.webp",
        ...
        <div className="relative overflow-hidden">
          ...
          >
            {services.map((service, index) => (
              <div
                key={index}
                className="relative min-w-[300px] md:min-w-[400px] h-[580px] rounded-lg shadow-lg border-primary border
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[95%] mt-2 h-90 mx-auto object-cover"
                    onError={(e) => {
